@echo off
:: Generated on 2026-01-29 07:36:59 GMT
...
:START_PROCESS
title 26100.7701_amd64_zh-cn_professional_0ceb35ad download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=0ceb35ad-48d4-4480-af96-39ee7fc2dd0b&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
