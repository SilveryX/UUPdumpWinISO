@echo off
:: Generated on 2026-01-29 07:38:14 GMT
...
:START_PROCESS
title 26200.7701_amd64_zh-cn_professional_8bb29c80 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=8bb29c80-d46d-4b33-9d83-0401476ae19a&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
