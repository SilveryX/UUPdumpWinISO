@echo off
:: Generated on 2026-03-03 09:49:57 GMT
...
:START_PROCESS
title 26200.7922_amd64_zh-cn_professional_ec79ec03 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=ec79ec03-5218-45bc-918d-1a0571fc7b0a&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
