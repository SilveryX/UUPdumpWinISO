@echo off
:: Generated on 2026-01-29 07:30:28 GMT
...
:START_PROCESS
title 19044.6812_amd64_zh-cn_professional_24e0ae70 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=24e0ae70-6487-4cfe-9019-c165b561ca7e&pack=zh-cn&edition=professional&aria2=2"
